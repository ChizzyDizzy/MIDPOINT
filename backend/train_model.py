...
print("   " + "─" * 50)
print()
print("📝 For your MVP report, document:")
print("  - Training dataset: 20 mental health conversations")
print("  - Training method: Fine-tuning DialoGPT")
print("  - Model location: " + OUTPUT_DIR)
print("  - Test results from test_mvp.py")
print()
print("=" * 70)
print()
print("Need help? Check MODEL_TRAINING_GUIDE.md")
print()
