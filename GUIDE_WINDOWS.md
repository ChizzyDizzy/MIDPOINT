...
python generate_dataset.py --num-samples 500 --output ..\data\mental_health_dataset.json

:: For testing (10 samples, ~30 seconds):
:: python generate_dataset.py --num-samples 10 --output ..\data\test_dataset.json
```
